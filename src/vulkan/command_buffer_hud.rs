...
{
	let current_command_buffer = vk_handle.command_buffer_hud_vec[vk_handle.current_frame];
		...
		vec![
			VkClearValue{
				color: VkClearColorValue{
					float32: [0.0f32, 0.0f32, 0.0f32, 0.0f32] // THIS IS SET TO FULLY TRANSPARENT ( it doesnt matter cause loadOp is LOAD)
				}
			},
			VkClearValue{
